 ...
 * `viewModelOf(::SchedulePaymentViewModel)`, which resolves **every** constructor parameter from the
 ...
 */
class SchedulePaymentModuleTest {
    ...
    private val stubs = module {
        ...
        single<ScheduledPaymentInitiationRepository> {
            object : ScheduledPaymentInitiationRepository {
                ...
                override fun stagedDraft(): ScheduledPaymentDraft? = null
            }
        }
