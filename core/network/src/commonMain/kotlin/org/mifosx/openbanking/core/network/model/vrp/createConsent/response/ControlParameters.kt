...
data class ControlParameters(
    ...
    val maximumIndividualAmount: MaximumIndividualAmount? = null,
    @SerialName("PeriodicLimits")
    val periodicLimits: List<PeriodicLimit>? = null,
    @SerialName("VRPType")
    val vrpType: List<String>? = null,
    @SerialName("PSUAuthenticationMethods")
    val psuAuthenticationMethods: List<String>? = null,
